...
import { RequestPasswordResetEmailQueueProcessorService } from './auth-queue-services/request-password-reset-email-queue-processor.service';
...
@Module({
  ...
  providers: [
    ...
    RequestPasswordResetEmailQueueProcessorService,
